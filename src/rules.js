...
const rulesMap = {
  ...
  "https://time.com/": `h1, h3, .summary, .video-title, #article-body ${defaultSelector}, .image-wrap-container .credit.body-caption, .media-heading`,
  ...
  "https://github.com/": `.markdown-body ${defaultSelector}, .repo-description p, .Layout-sidebar .f4, .container-lg .py-4 .f5, .container-lg .my-4 .f5, .Box-row .pr-4, .Box-row article .mt-1, [itemprop="description"], .markdown-title, bdi`,
